...
@Service
@Slf4j
@Qualifier("kafkaValidationStrategy")
public class OnboardingValidationStrategyKafkaImpl implements OnboardingValidationStrategy {
    private static final String TESTING_PRODUCT_SUFFIX = "coll";
    private final InternalApiConnector internalApiConnector;

    public OnboardingValidationStrategyKafkaImpl(InternalApiConnector internalApiConnector) {
        log.info("Initializing {}...", OnboardingValidationStrategyKafkaImpl.class.getSimpleName());
